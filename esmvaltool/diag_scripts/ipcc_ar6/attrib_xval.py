...
#  attrib_range=[attrib_warming-attrib_warming*(((beta-betaCI[0])/beta)**2+(ci95_dec_warming/dec_warming)**2)**0.5,attrib_warming+attrib_warming*(((betaCI[1]-beta)/beta)**2+(ci95_dec_warming/dec_warming)**2)**0.5]
...
#            print ('other_mean_dec_warming[0:3]',other_mean_dec_warming[0:3])
            print ('Simulated GHG warming',mean_dec_warming[2,mms],'GHG-attrib warming',numpy.transpose(att_out['betaCI'][2,:]*other_mean_dec_warming[2]))
            ...
            print ('Simulated OTH warming',mean_dec_warming[0,mms],'OTH-attrib warming',numpy.transpose(att_out['betaCI'][0,:]*other_mean_dec_warming[0]))
            for experiment in range(0,3):
                ...
                plt.plot([mean_dec_warming[experiment,mms]+offset,mean_dec_warming[experiment,mms]+offset],att_range,color=shade_cols[cols[experiment],:],zorder=1,linewidth=0.2)
